                ...
                @forelse ($this->leaves as $leave)
                    <tr x-data="{leave: {{ $leave->id }}}">
                        ...
                        <td class="border border-gray-darkest px-4 py-3 whitespace-no-wrap">
                            ...
                            {{-- <span type="button" class="w-max inline-flex justify-center font-bold shadow-none p-2 bg-green-300 text-white border-none rounded-full focus:outline-none sm:mr-2 sm:w-20 sm:text-sm">
                            </span> --}}
                        </td>
                        ...
                        <td class="border border-gray-darkest px-4 py-3 whitespace-no-wrap">
                            <div class="flex items-center justify-around h-full">
                                @if ($leave->status == 'pending')
                                    <button @click="$wire.call('updateLeave', leave, 'approved');" type="button" class="w-max inline-flex justify-center font-bold shadow-none p-2 bg-green-300 text-white border-none rounded-full focus:outline-none sm:mr-2 sm:w-20 sm:text-sm">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="fill-green-400 h-5 w-5 mr-4" viewBox="0 0 20 20" fill="currentColor">
                                            <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd" />
                                        </svg>
                                        {{ __('Approved') }}
                                    </button>
                                    <button @click="$wire.call('updateLeave', leave, 'refused');" type="button" class="w-max inline-flex justify-center font-bold shadow-none p-2 bg-red-300 text-white border-none rounded-full focus:outline-none sm:mr-2 sm:w-20 sm:text-sm">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="fill-red-400 h-5 w-5 mr-4" viewBox="0 0 20 20" fill="currentColor">
