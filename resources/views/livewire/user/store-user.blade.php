<div class="text-left pl-20 py-6">
    ...
    <form wire:submit.prevent="submit">
        ...
        <div class="mt-4 w-132">
            ...
            <select id="role" wire:model="role" class="form-select block shadow-none focus:shadow-none rounded-none text-sm w-full py-3 mt-2 {{ $errors->has('role') ? 'text-red-400 placeholder:text-red-400 border-red-400' : '' }}" name="role">
        ...
        <div class="mt-4 w-132 relative" x-data>
            <x-jet-input id="password" wire:model="password" class="form-input block shadow-none focus:shadow-none rounded-none text-sm w-full py-3 pr-32 {{ $errors->has('password') ? 'text-red-400 placeholder:text-red-400 border-red-400' : '' }}" type="text" name="password" placeholder="{{ __('Password') }}" required />
