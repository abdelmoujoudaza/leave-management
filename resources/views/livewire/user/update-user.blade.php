<div class="text-left pl-20 py-6">
    ...
    <form wire:submit.prevent="submit">
        ...
        <div class="mt-4 w-132">
            <x-jet-input id="national_id" wire:model="user.national_id" class="form-input block shadow-none focus:shadow-none rounded-none text-sm w-full py-3 {{ $errors->has('user.national_id') ? 'border-red-400' : '' }}" type="text" name="national_id" placeholder="{{ __('National id') }}" required autofocus autocomplete="current-national-id" />
        </div>

        <div class="mt-4 w-132">
            <x-jet-input id="firstname" wire:model="user.firstname" class="form-input block shadow-none focus:shadow-none rounded-none text-sm w-full py-3 {{ $errors->has('user.firstname') ? 'border-red-400' : '' }}" type="text" name="firstname" placeholder="{{ __('Firstname') }}" required autofocus autocomplete="current-firstname" />
        </div>

        <div class="mt-4 w-132">
            <x-jet-input id="lastname" wire:model="user.lastname" class="form-input block shadow-none focus:shadow-none rounded-none text-sm w-full py-3 {{ $errors->has('user.lastname') ? 'border-red-400' : '' }}" type="text" name="lastname" placeholder="{{ __('Lastname') }}" required autocomplete="current-lastname" />
        </div>

        <div class="mt-4 w-132 relative" x-data>
            <x-jet-input id="password" wire:model="password" class="form-input block shadow-none focus:shadow-none rounded-none text-sm w-full py-3 pr-32 {{ $errors->has('password') ? 'border-red-400' : '' }}" type="text" name="password" placeholder="{{ __('Password') }}" required />
        ...
        <div class="mt-4 w-132">
            <x-jet-input id="position" wire:model="user.position" class="form-input block shadow-none focus:shadow-none rounded-none text-sm w-full py-3 {{ $errors->has('user.position') ? 'border-red-400' : '' }}" type="text" name="position" placeholder="{{ __('Position') }}" required autocomplete="current-position" />
        </div>

        <div class="mt-4 w-132">
            <x-jet-input id="address" wire:model="user.address" class="form-input block shadow-none focus:shadow-none rounded-none text-sm w-full py-3 {{ $errors->has('user.address') ? 'border-red-400' : '' }}" type="text" name="address" placeholder="{{ __('Address') }}" required autocomplete="current-address" />
        </div>

        <div class="mt-4 w-132">
            <x-jet-input id="birth" wire:model="user.birth" class="form-input block shadow-none focus:shadow-none rounded-none text-sm w-full py-3 {{ $errors->has('user.birth') ? 'border-red-400' : '' }}" type="date" name="birth" placeholder="{{ __('Birth') }}" required />
        </div>
