    ...
    <div class="w-full max-w-full relative overflow-x-scroll mb-4">
        <table class="w-full table-auto border-collapse text-sm text-left">
            <thead class="text-gray-300 bg-gray-800">
                ...
                <th class="border border-gray-800 border-r-white px-4 py-3">{{ __('Driver') }}</th>
                <th class="border border-gray-800 px-4 py-3">{{ __('Actions') }}</th>
            </thead>
                    ...
                    <tr x-data="{direction: {{ $direction->id }}}">
                        ...
                        <td class="border border-gray-darkest px-4 py-3">
                            <div class="flex items-center justify-around h-full">
                                <a href="{{ route('direction.show', ['direction' => $direction->id]) }}" class="cursor-pointer mx-px">
